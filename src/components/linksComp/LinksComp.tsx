    ...
    return (
        <div className={styles.container}>
            <div className={styles.linksContainer}>
                ...
                <a href="https://github.com/jorgeacosta02" target='blank'>
                    <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="24" height="24" 
                    viewBox="0 0 24 24"
                ...
                <a href="https://www.facebook.com/jorge.acostadeleon" target='blank'>
                    <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="24" 
                    height="24" 
                ...
                <a href="https://twitter.com/JorgeA78789" target='blank'>
                    <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    width="24" 
                    height="24" 
